...
namespace BusinessLogic
{
    ...
    public class SampleLogicConfig : IValidatableConfiguration
    {
        ...
        public IEnumerable<ConfigurationValidationItem> Validate()
        {
            ...
            validations.ValidateMust(c => c.SomeEndpoint.StartsWith("https", StringComparison.OrdinalIgnoreCase), nameof(this.SomeEndpoint), "Enpoint is not SSL secured.");
