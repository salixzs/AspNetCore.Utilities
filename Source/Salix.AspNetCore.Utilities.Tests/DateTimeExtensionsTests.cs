...
namespace Salix.AspNetCore.Utilities.Tests
{
    public class DateTimeExtensionsTests
    {
        ...
        public static IEnumerable<object[]> HumanDateStringTestData()
        {
            ...
            yield return new object[] { new DateTime(DateTime.Now.Year, DateTime.Now.Month, DateTime.Now.Day, 14, 23, 15), null, 5, "Today (14:23)" };
            ...
            yield return new object[] { new DateTime(DateTime.Now.AddDays(-1).Year, DateTime.Now.AddDays(-1).Month, DateTime.Now.AddDays(-1).Day, 14, 23, 15), null, 5, "Yesterday (14:23)" };
            ...
            yield return new object[] { DateTime.Now.AddDays(-1), null, 1, "Yesterday" };
